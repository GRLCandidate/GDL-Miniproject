...
# Here's whhat plots I need

* A plot of a graph with a length 1 and a length 2 task, with solution
* A plot of training
* data about class imbalance
* data about test accuracies of
    * the best GRAFF/LayeredGRAFF/GCN for each dataset
    * the one that guesses the bigger class
    * both percentage score and dice score
